# Introduction to Backendless Pro
...
* **On-Premises Installation**: Backendless Pro can be easily installed on your own infrastructure, ensuring complete control over your environment and data.
* **Cloud Compatibility**: It's compatible with both public and private cloud environments, making it a versatile choice for cloud-based applications.
* **Docker and Kubernetes Support**: Backendless Pro is designed to run in environments where Docker and Kubernetes are available, leveraging these technologies for efficient, scalable deployments.
...
* Bulk Email Sending: Facilitates sending emails to large groups of recipients efficiently.
Attachment Support: Enables sending attachments along with emails.
...
* File Metadata: Allows attaching custom metadata to files, facilitating better organization and retrieval.
Supports retrieving and modifying file metadata. (This feature uses Backendless Database as the mechanism to store metadata information).
...
* **Automated Management**: Kubernetes automates various aspects of application deployment, scaling, and management, significantly simplifying these processes.
This overview provides a glimpse into the capabilities and versatility of Backendless Pro. For detailed installation instructions, configuration options, and best practices, please refer to the subsequent chapters.