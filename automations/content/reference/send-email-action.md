...
The **Send Email** block automates the process of sending emails. This block can be configured to send emails using a predefined template and can target specific recipients either explicitly or based on query from your Backendless database.
...
The **Send Email** block includes the following configuration properties:
