...
#### Advanced Mode 
For scenarios where the delay needs to be more flexible, the Advanced Mode comes into play. This mode utilizes the [Expression Editor](./expressioneditor.md), which allows you to calculate the delay period dynamically. Whether through a variable, a property, or a custom expression, the resulting value determines the length of the pause, measured in seconds.
