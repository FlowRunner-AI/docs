...
With AI Router, your flows can make smarter decisions based on patterns, trends, or natural language inputs, ensuring that your application can adapt in real-time to different situations or data inputs. 

For more information about the functionality, to learn how to configure and use AI Routers, visit the [AI Router](../reference/ai-router-action.md) section of this guide.

![ai router sample](../images/ai-router-sample.png)
...
For more information about API Assistants, visit the [AI Assistants](../reference/ai-assistant.md) section of this guide.

![ai assistant demo](../images/ai-assistant-demo.png)
...
![ai image check](../images/ai-condition-check.png)
